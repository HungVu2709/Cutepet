// popup form
document.querySelector("#openLoginForm").addEventListener("click", function () {
...
window.onclick = function (event) {
  let formLoginPopUp = document.getElementById("popUpLogin");

  if (event.target == formLoginPopUp) {
    formLoginPopUp.classList.remove("active");
  }
};
...
// icon eye to see password
document.querySelector("#seePassword").addEventListener("click", function () {
  const type =
...
//icon eye to see confirm password
document
  .querySelector("#seeConfirmPassword")
  .addEventListener("click", function () {
    const type =
      document.querySelector("#password_confirmation").getAttribute("type") ===
      "password"
        ? "text"
        : "password";
    document.querySelector("#password_confirmation").setAttribute("type", type);
    const togglePassword = document.querySelector("#seeConfirmPassword");
    togglePassword.classList.toggle("fa-eye-slash");
    togglePassword.classList.toggle("fa-eye");
  });
//
...
Validator.isRequired = function (selector, message) {
  return {
    selector: selector,
    test: function (value) {
      return value ? undefined : message || "This field can not be empty ";
    },
  };
};
